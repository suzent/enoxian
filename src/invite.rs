...
pub struct InvitePayload {
    ...
    /// Circuit relay multiaddr (e.g. /ip4/1.2.3.4/tcp/4001/p2p/<peer_id>).
    /// Joinees add this to their relay_addrs and use it for WAN connectivity.
    pub relay_addr: Option<String>,
    /// Rendezvous server multiaddr (QUIC, e.g. /ip4/1.2.3.4/udp/4001/quic-v1/p2p/<peer_id>).
...
mod tests {
    ...
    fn round_trip_basic() {
        ...
        let payload = InvitePayload {
            ...
            relay_addr:  Some("/ip4/5.6.7.8/tcp/4001/p2p/12D3KooWtest".to_string()),
            rendezvous_addr: Some("/ip4/9.10.11.12/udp/4001/quic-v1/p2p/12D3KooWrdvz".to_string()),
        };
        ...
        assert_eq!(decoded.relay_addr.as_deref(), Some("/ip4/5.6.7.8/tcp/4001/p2p/12D3KooWtest"));
        assert_eq!(decoded.rendezvous_addr.as_deref(), Some("/ip4/9.10.11.12/udp/4001/quic-v1/p2p/12D3KooWrdvz"));
